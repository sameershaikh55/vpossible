...
const Support = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      p: (
        <p className="mb-0">
          ...
          need. vPossible serves as your “one stop shop” for all your managed IT
    ...
    },
    {
      ...
      p: (
        <p className="mb-0">
          Simply put, vPossible Managed IT Services means we take care of your
          ...
          staffing needs. It also means vPossible acts as your go-to consultancy
    ...
    },
    {
      ...
      p: (
        <p className="mb-0">
          ...
          vPossible makes it simple with an affordable and customised flat rate
          service plan.
        </p>
      ),
    },
  ...
  return (
    <div>
      ...
      <Seo
        title="Support - vPossible.au"
        description="Get the best IT services and support in Australia for your business."
        canonical="https://www.vpossible.com.au/support"
        robot="https://www.vpossible.com.au/support"
      />
